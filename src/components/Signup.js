...
class Signup extends Component { 
    ...
    render() {
        ...
        <Card style={styles.projectSetting}>
            <input name="email" type='text' placeholder='Email' value={this.state.email} onChange={this.onFormChange}/>
            <input name="password" type='password' placeholder='Password' value={this.state.password} onChange={this.onFormChange}/>
